...
namespace AMPM.PROJECT
{
    ...
    public class productList
    {
        ...
        public Product this[int index] //set and get value in index
        {
            get
            {
        ...
        public void Remove(int element) //remove product from list
        {
        ...
        public void calcSales() //calculate total price with sales
        {
